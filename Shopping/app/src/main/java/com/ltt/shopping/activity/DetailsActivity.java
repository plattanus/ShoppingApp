...
import com.ltt.shopping.adapter.SameLinkGridApter;
import com.ltt.shopping.callbacks.BaseCallback;
import com.ltt.shopping.constant.Constants;
import com.ltt.shopping.models.CommodityModel;
import com.ltt.shopping.utils.LoginCheckUtil;
import com.ltt.shopping.utils.NetUtil;
import com.ltt.shopping.utils.SharedPreferencesUtil;
import com.ltt.shopping.widget.MyCartDialog;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        mBtnAsk = findViewById(R.id.btn_ask);
        //设置购买按钮的图标
        Drawable btnAskDrawable = getResources().getDrawable(R.drawable.collection);
        //必须设置图片大小，否则不显示图片
        btnAskDrawable.setBounds(0, 0, 100, 100);
        mBtnAsk.setCompoundDrawables(btnAskDrawable, null, null, null);
        mBtnAsk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(mContext, "该功能有待完善", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void initSameCommodity(CommodityModel commodityModel) {
        ...
        String url = Constants.BASE_URL + Constants.GET_COMMODITY_URL + "?limit=3&page=" + randomPage;
    ...
    private void initCommodityData() {
        //构造url
        String url = Constants.BASE_URL + Constants.GET_COMMODITY_BY_ID_URL + productId;
