package com.ltt.shopping.constant;
...
public class Constants {
     ...
     * 基础广告地址利用cdsn网站获取
     */
    public static final String BASE_ADS_URL = "https://img-blog.csdnimg.cn";
     ...
     */
    public enum ADS {
        ADS_URL0("/20210630153432421.jpg", "广告1"),
        ADS_URL1("/2021063015294916.jpg", "广告2"),
        ADS_URL2("/20210630153003453.jpg", "广告3"),
        ADS_URL3("/20210630153548307.jpg", "广告4");
        String url;
        String message;
